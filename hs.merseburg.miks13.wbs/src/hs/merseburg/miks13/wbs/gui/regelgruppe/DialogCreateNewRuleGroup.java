...
public class DialogCreateNewRuleGroup extends Dialog {
	 ...
	 * @param wbsID
	 */
	public DialogCreateNewRuleGroup(Shell parentShell, long wbsID) {
		super(parentShell);
		WBSID = wbsID;
	}
	...
	protected void okPressed() {
		...
		WissensBasis wbs = PersistenceUtility.getWissensBasisById(WBSID,
				session);
		Regelgruppe regelgruppe = WissensbasismodelFactory.eINSTANCE
				.createRegelgruppe();
		...
		wbs.getRegelGruppen().add(regelgruppe);
